    ...
    <body>
        ...
        <main class="container text-center">
            <div class="row mb-2 mt-4">
                <h3><fmt:message key="user.list.header"/></h3>
            </div>
                ...
                <table class="table align-middle m-auto">
                    <thead class="table-light text-start">
                        <tr class="table-primary">
                            ...
                            <th><fmt:message key="user.table.header.username"/></th>
                            <th><fmt:message key="user.table.header.user-type"/></th>
                            <th><fmt:message key="user.table.header.status"/></th>
                        </tr>
                    </thead>
                    ...
                    <tbody class="text-start">
                        <c:forEach items='${users}' var='user'>
                            <tr>
                                ...
                                <td><c:out value="${user.userType.value}"/></td>
