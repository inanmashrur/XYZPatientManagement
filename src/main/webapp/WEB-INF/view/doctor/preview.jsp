...
<c:if test="${commandDoctor.id != null}">
    ...
    <body id="body-id">
        ...
        <main class="container text-center">
            ...
            <div class="row card border-0 shadow p-5 col-10 col-sm-8 col-md-8 col-lg-5 m-auto">
                <form:form modelAttribute="commandDoctor" action="/doctor/preview" method="post">
                    <div class="form-floating mt-2 mb-1 shadow">
                        <form:input path="user.firstName" class="form-control" type="text" placeholder="fname" readonly="true"/>
                    ...
                    <div class="form-floating mt-2 mb-1 shadow">
                        <form:input path="user.lastName" class="form-control" type="text" placeholder="lname" readonly="true"/>
                    ...
                    <div class="form-floating mb-1 shadow">
                        <form:input path="user.username" cssClass="form-control" type="text" placeholder="username" readonly="true"/>
                    ...
                    <div class="form-floating mt-2 mb-1 shadow">
                        <form:input path="education" class="form-control" type="textarea" placeholder="ed" readonly="true"/>
                    ...
                    <div class="form-floating mt-2 mb-1 shadow">
                        <form:input path="specialities" class="form-control" type="textarea" placeholder="sp" readonly="true"/>
