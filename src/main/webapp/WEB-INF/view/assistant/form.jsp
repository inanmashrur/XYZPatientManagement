...
<html>
    <head>
        ...
        <title><fmt:message key="assistant.form.title"/></title>
    </head>
    ...
    <body id="body-id">
        ...
        <main class="container text-center">
            <div class="row mb-4">
                <h3 id="form-title"><fmt:message key="assistant.form.header"/></h3>
            </div>

            <div class="row card border-0 shadow p-5 col-10 col-sm-8 col-md-8 col-lg-5 m-auto">
                <form:form modelAttribute="commandAssistant" action="/assistant/form" method="post">
